...
public class ServiceDirectory6 {
	...
	public static String service(int ser,int param1,int param2)
	{
		...
		hashown.put("http://10.200.59.148:8087/Server6/services/Addition?wsdl","add");
		hashown.put("http://10.200.59.148:8087/Server6/services/Multiplication?wsdl","multiply");
		hashown.put("http://10.200.59.148:8087/Server6/services/ServiceDirectory6?wsdl","sdirectory");
		...
		else
		{
			...
			if(finalanswer!=1)
			{
				...
				String wsdl ="";
				//Fetching the final server values from answer hashmap corresponding to the smallest time elapsed. 
				for (String key_wsdl : hashanswer1.keySet()) {
					wsdl = key_wsdl;
					if(key1== key){
						break;
					}
